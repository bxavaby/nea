class ThemeSwitcher {
  constructor() {
    ((this.themeColorMeta = document.getElementById("theme-color-meta")),
      ...
      (this.themes = { LIGHT: "digital-paper", DARK: "trash-panda" }));
  }
  updateThemeColor() {
    var e;
    this.themeColorMeta &&
